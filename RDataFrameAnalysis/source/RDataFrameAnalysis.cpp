...
int main(int argc, char **argv)
{
	...
	// Declare an output data object
	ExampleOutputDataClass outputData;

	// Custom function to process input data and return modified outputData.
	...
	{
		// This example simply fills the sum of data1 and data2 into the output object.
	...
	// Returns true if data1 is grater than 1.
